...
public class ClientDetails extends BasicClientInfo {
  ...
  public String toString() {
    return "ClientDetails [resourceIds=" + resourceIds + ", scope=" + scope + ", grantTypes="
        + grantTypes + ", roles=" + roles + ", accessTokenValidity=" + accessTokenValidity
        + ", refreshTokenValidity=" + refreshTokenValidity + ", trusted=" + trusted + ", archived="
        + archived + ", createTime=" + createTime + "]";
  }
